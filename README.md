...
<section id="crm-campaigns" class="py-16 px-4 bg-gray-100 text-gray-800">
  <div class="max-w-5xl mx-auto">
    <h2 class="text-3xl font-bold mb-6 text-center">CRM Campaigns</h2>

    <!-- CRM Campaign - Cleantech GrowthLab -->
    <div class="mb-12">
      <h3 class="text-2xl font-semibold mb-4">1. CRM Campaign – Cleantech GrowthLab</h3>
      <p><strong>Objective:</strong> Increase engagement and conversion of clean tech leads, boosting Sales Qualified Leads (SQL) through automated nurturing, content, and product demos.</p>
      <p><strong>Audience:</strong> Small-to-medium enterprises (SMEs), corporate sustainability teams, and environmentally-conscious investors.</p>
      <p><strong>Tools:</strong> HubSpot CRM, Mailchimp, Google Analytics.</p>
      <p><strong>Goal:</strong> Increase SQLs by educating leads and offering personalized demo sessions for clean tech solutions.</p>
      
      <h4 class="font-semibold mt-4">Campaign Strategy:</h4>
      <ul class="list-disc pl-6 mt-2">
        <li><strong>Segmentation:</strong> SMEs, sustainability teams, eco-conscious investors.</li>
        <li><strong>Email Campaign Flow:</strong>
          <ul class="list-decimal pl-6 mt-2">
            <li><strong>Stage 1:</strong> Welcome email introducing Cleantech GrowthLab, with a CTA to download a whitepaper on renewable energy solutions.</li>
            <li><strong>Stage 2:</strong> Educational content about the impact of clean tech on global markets, including case studies.</li>
            <li><strong>Stage 3:</strong> Lead nurturing with a personalized demo invitation.</li>
          </ul>
        </li>
        <li><strong>Metrics:</strong> 44% open rate, 12% click-through rate, 8% demo-to-contract conversion rate.</li>
        <li><strong>Results:</strong> 10× SQL growth, and $X in revenue generated from demos and consultations.</li>
      </ul>
    </div>

    <!-- CRM Campaign - iGaming Platforms -->
    <div class="mb-12">
      <h3 class="text-2xl font-semibold mb-4">2. CRM Campaign – iGaming Platforms</h3>
      <p><strong>Objective:</strong> Reactivate dormant users and increase the retention of VIP players using personalized offers, loyalty programs, and targeted messaging.</p>
      <p><strong>Audience:</strong> Dormant players, VIP players, and new registrants.</p>
      <p><strong>Tools:</strong> Salesforce CRM, Mailchimp, SMS Marketing Tools (e.g., Twilio).</p>
      <p><strong>Goal:</strong> Reactivate dormant users and encourage VIP users to stay engaged with special rewards and offers.</p>

      <h4 class="font-semibold mt-4">Campaign Strategy:</h4>
      <ul class="list-disc pl-6 mt-2">
        <li><strong>Segmentation:</strong> Dormant players, VIP players, new registrants.</li>
        <li><strong>Email Campaign Flow:</strong>
          <ul class="list-decimal pl-6 mt-2">
            <li><strong>Stage 1:</strong> Re-engagement email offering free bonuses for dormant users.</li>
            <li><strong>Stage 2:</strong> Exclusive offers and rewards for VIP players via email/SMS.</li>
            <li><strong>Stage 3:</strong> Onboarding and bonuses for new users to increase conversion rates.</li>
          </ul>
        </li>
        <li><strong>Metrics:</strong> 25% reactivation rate of dormant users, 20% increase in VIP retention, +20% LTV.</li>
        <li><strong>Results:</strong> 25% dormant user reactivation, 20% VIP retention, +20% LTV increase.</li>
      </ul>
    </div>

    <!-- CRM Campaign - National Chromatography Inco -->
    <div class="mb-12">
      <h3 class="text-2xl font-semibold mb-4">3. CRM Campaign – National Chromatography Inco</h3>
      <p><strong>Objective:</strong> Drive adoption of chromatography equipment in pharmaceutical labs and universities, through personalized lead nurturing and automated follow-ups.</p>
      <p><strong>Audience:</strong> Pharmaceutical companies, R&D labs, university researchers, and laboratory managers.</p>
      <p><strong>Tools:</strong> Salesforce Pardot, Mailchimp, LinkedIn Outreach.</p>
      <p><strong>Goal:</strong> Increase lead-to-opportunity conversion by automating follow-ups, providing educational content, and offering personalized demos.</p>

      <h4 class="font-semibold mt-4">Campaign Strategy:</h4>
      <ul class="list-disc pl-6 mt-2">
        <li><strong>Segmentation:</strong> Pharmaceutical R&D, QC Labs, Universities.</li>
        <li><strong>Email Campaign Flow:</strong>
          <ul class="list-decimal pl-6 mt-2">
            <li><strong>Stage 1:</strong> Product introduction email with a focus on ROI for pharmaceutical research labs.</li>
            <li><strong>Stage 2:</strong> Educational case studies showcasing chromatography success stories.</li>
            <li><strong>Stage 3:</strong> Personalized demo invitations to showcase product benefits for specific needs.</li>
          </ul>
        </li>
        <li><strong>Metrics:</strong> 13% lead-to-opportunity conversion, 40% demo click rate, $35k in closed deals.</li>
        <li><strong>Results:</strong> $35k in revenue, 13% lead-to-opportunity conversion rate, high engagement with demo offers.</li>
      </ul>
    </div>
